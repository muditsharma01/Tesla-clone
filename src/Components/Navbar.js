...
const Navbar = () => {
  ...
  return (
    <div>
        <div className="bg-white p-4 text-center text-sm text-black">
        Up to $7,500 tax credit available for Model Y and Model 3. <a href="#" className="underline">Learn More</a>
      </div>
